...
export default function Score({ qualification, size, className }: Props) {
  ...
  return (
    <div
      className={`flex justify-items-center gap-1 w-max ${className}`}
      aria-label={`Calificación general de ${qualification} estrellas.`}
    >
      {stars}
    </div>
  );
